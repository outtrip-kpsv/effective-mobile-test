  ...
  for data := range out {
    ...
    case reflect.TypeOf(&models.Genderize{}):
      ...
      if ok {
        ...
        b.Logger.Info("Genderize", zap.String("name", genderizeData.Name), zap.String("age", genderizeData.Gender))
    ...
    case reflect.TypeOf(&models.Nationalize{}):
      ...
      if ok {
        if len(nationalizeData.Country) > 0 {
          ...
          b.Logger.Info("Nationalize", zap.String("name", nationalizeData.Name), zap.String("age", person.CountryID))
